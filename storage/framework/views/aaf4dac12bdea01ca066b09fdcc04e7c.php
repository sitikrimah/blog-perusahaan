                           ...
                           <section class="page-section bg-light" id="portfolio">
                            <div class="container">
                                <div class="text-center">
                                    ...
                                    <a href="<?php echo e(url('project/add')); ?>"><button class="btn btn-primary">Tambah Data</button></a>
                                    ...
                                    <div class="col-lg-4 col-sm-6 mb-4">
                                        ...
                                        <div class="portfolio-item">
                                            ...
                                            <div class="portfolio-caption">
                                                <div class="portfolio-caption-heading"><?php echo e($item->name); ?></div>
                    ...
                    <div class="container">
                        ...
                        <form id="contactForm" data-sb-form-api-token="API_TOKEN">
                            <div class="row align-items-stretch mb-5">
                                <div class="col-md-6">
                                    <form action="<?php echo e(url('ks/create')); ?>" method="post" enctype="multipart/form-data">
                                        ...
                                        <div class="row justify-content-center">
                                            <div class="col-lg-8">
                                                <div class="modal-body">
                                                    <!-- Project details-->
                                                    <h2 class="text-uppercase"><?php echo e($item->name); ?></h2>
...
<?php /**PATH C:\xampp\htdocs\Blog_tugas_pkl\resources\views/project.blade.php ENDPATH**/ ?>